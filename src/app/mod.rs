...
use leptos::prelude::*;
use leptos_meta::{provide_meta_context, Meta, Title, Stylesheet, Link};
...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Title text="Techno Penguin | Precision Technical Services"/>
        ...
        <nav class="sticky top-0 z-50 border-b bg-white/80 backdrop-blur-md border-slate-100">
            <div class="container flex justify-between items-center px-6 mx-auto h-20">
                <a href="/" class="flex items-center space-x-2">
                    ...
                    <span class="text-2xl font-bold tracking-tight text-slate-900">"Techno Penguin"</span>
                </a>
                <div class="hidden items-center space-x-8 font-semibold md:flex text-slate-600">
                    <a href="/#pricing" class="transition hover:text-amber-500">"Pricing"</a>
                    <a href="/training" class="transition hover:text-amber-500">"Training"</a>
                    <a href="/assembly" class="transition hover:text-amber-500">"Assembly"</a>
                    <a href="/#contact" class="py-2 px-6 text-white rounded-full transition bg-slate-900 hover:bg-slate-800">"Contact"</a>
                </div>
            </div>
        </nav>
    }
            ...
            <div class="container grid grid-cols-1 gap-12 px-6 mx-auto md:grid-cols-4">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center mb-6 space-x-2">
                        ...
                        <span class="text-xl font-bold tracking-tight text-white">"Techno Penguin"</span>
                    </div>
                    <p class="max-w-xs">"Delivering precision engineering and technical training for modern enterprises. Built with Rust and Leptos."</p>
                </div>
                <div>
                    <h4 class="mb-4 font-bold text-white">"Services"</h4>
                    <ul class="space-y-2">
                        <li><a href="/assembly" class="transition hover:text-amber-500">"Assembly"</a></li>
                        <li><a href="/training" class="transition hover:text-amber-500">"Training"</a></li>
                        <li><a href="/#pricing" class="transition hover:text-amber-500">"Pricing"</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="mb-4 font-bold text-white">"Connect"</h4>
                    <ul class="space-y-2">
                        <li><a href="#" class="transition hover:text-amber-500">"Twitter"</a></li>
                        <li><a href="#" class="transition hover:text-amber-500">"LinkedIn"</a></li>
                        <li><a href="/#contact" class="transition hover:text-amber-500">"Contact"</a></li>
                    </ul>
                </div>
            </div>
